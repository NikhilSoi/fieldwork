  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="text-lg font-bold text-white">{team.name} — Nova Analysis</h3>
      </div>
      ...
      {ROUND_ORDER.map((roundKey) => {
        ...
        return (
          <div key={roundKey} className="rounded-2xl p-5" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', backdropFilter: 'blur(12px)', borderRadius: '16px' }}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-xs text-white/40 font-mono capitalize">{roundKey} Round</p>
            </div>
